...
?>
    <!-- Page Content -->
    <div class="container-fluid" style= "background:linear-gradient(to top,rgba(0, 0, 0, 0.7)50%,rgba(0,0,0,0.7)50%)">
	  <div class="row">
		<div class="col-lg-2">
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Equipment</a>
			  ...
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Vendor</a>
   			  <a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false">Assignments</a> 
		 ...
		 <div class="col-lg-10"style="background-image:url('image/OIP.jpg')">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
							<label for="saleDetailsCustomerID">User ID<span class="requiredIcon">*</span></label>
						...
						<div class="form-group col-md-4">
						  <label for="saleDetailsCustomerName">User Name</label>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  <label for="saleDetailsSaleDate">Date<span class="requiredIcon">*</span></label>
					  ...
					  <button type="button" id="addSaleButton" class="btn btn-success">Assign</button>
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						 ...
						 <div class="form-group col-md-3">
							<label for="customerDetailsCustomerID">User ID</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<!--<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#customerSearchTab">User</a> 
						</li> -->
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#saleSearchTab">Assignments</a> 
						</li>
						<li class="nav-item">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#customerReportsTab">User</a>
						</li>
						<li class="nav-item">
